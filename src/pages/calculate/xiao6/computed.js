const boyScoreStandards = {
	...
	fiftyMeter: [
		...
		{ score: 85, min: 8.5, max: 8.5 },
		{ score: 80, min: 8.6, max: 8.6 },
		{ score: 78, min: 8.7, max: 8.8 },
		{ score: 76, min: 8.9, max: 9.0 },
		{ score: 74, min: 9.1, max: 9.2 },
		{ score: 72, min: 9.3, max: 9.4 },
		{ score: 70, min: 9.5, max: 9.6 },
		{ score: 68, min: 9.7, max: 9.8 },
		{ score: 66, min: 9.9, max: 10.0 },
		{ score: 64, min: 10.1, max: 10.2 },
		{ score: 62, min: 10.3, max: 10.4 },
		{ score: 60, min: 10.5, max: 10.6 },
		{ score: 50, min: 10.7, max: 10.8 },
		{ score: 40, min: 10.9, max: 11.0 },
		{ score: 30, min: 11.1, max: 11.2 },
		{ score: 20, min: 11.3, max: 11.4 },
		{ score: 10, min: 11.5, max: 11.6 }
	],
	// 类似方式添加其他项目的评分标准
	bmi: [
