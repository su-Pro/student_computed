const boyScoreStandards = {
  ...
  fiftyMeter: [
    ...
    { score: 78, min: 8.8, max: 8.8 },
    { score: 76, min: 9.0, max: 9.0 },
    { score: 74, min: 9.2, max: 9.2 },
    { score: 72, min: 9.4, max: 9.4 },
    { score: 70, min: 9.6, max: 9.6 },
    { score: 68, min: 9.8, max: 9.8 },
    { score: 66, min: 10.0, max: 10.0 },
    { score: 64, min: 10.2, max: 10.2 },
    { score: 62, min: 10.4, max: 10.4 },
    { score: 60, min: 10.6, max: 10.6 },
    { score: 50, min: 10.8, max: 10.8 },
    { score: 40, min: 11.0, max: 11.0 },
    { score: 30, min: 11.2, max: 11.2 },
    { score: 20, min: 11.4, max: 11.4 },
    { score: 10, min: 11.6, max: Infinity },
  ],
  // 类似方式添加其他项目的评分标准
  bmi: [
  ...
  eightTimesFiftyMeter: [
    ...
    { score: 10, min: 149, max: Infinity }, // 2'32" -> 152
  ],
};
...
const girlScoreStandards = {
  ...
  fiftyMeter: [
    ...
    { score: 95, min: 8.3, max: 8.3 },
    { score: 90, min: 8.4, max: 8.4 },
    { score: 85, min: 8.7, max: 8.7 },
    { score: 80, min: 9.0, max: 9.0 },
    { score: 78, min: 9.2, max: 9.2 },
    { score: 76, min: 9.4, max: 9.4 },
    { score: 74, min: 9.6, max: 9.6 },
    { score: 72, min: 9.8, max: 9.8 },
    { score: 70, min: 10.0, max: 10.0 },
    { score: 68, min: 10.2, max: 10.2 },
    { score: 66, min: 10.4, max: 10.4 },
    { score: 64, min: 10.6, max: 10.6 },
    { score: 62, min: 10.8, max: 10.8 },
    { score: 60, min: 11.0, max: 11.0 },
    { score: 50, min: 11.2, max: 11.2 },
    { score: 40, min: 11.4, max: 11.4 },
    { score: 30, min: 11.6, max: 11.6 },
    { score: 20, min: 11.8, max: 11.8 },
    { score: 10, min: 12.0, max: Infinity },
  ],
  // 类似方式添加其他项目的评分标准
  bmi: [
  ...
  eightTimesFiftyMeter: [
    ...
    { score: 10, min: 156, max: Infinity }, // 2'39" -> 159 seconds
  ],
};
