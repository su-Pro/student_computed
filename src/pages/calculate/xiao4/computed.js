const boyScoreStandards = {
	...
	fiftyMeter: [
		...
		{ score: 78, min: 9.2, max: 9.3 },
		{ score: 76, min: 9.4, max: 9.5 },
		{ score: 74, min: 9.6, max: 9.7 },
		{ score: 72, min: 9.8, max: 9.9 },
		{ score: 70, min: 10.0, max: 10.1 },
		{ score: 68, min: 10.2, max: 10.3 },
		{ score: 66, min: 10.4, max: 10.5 },
		{ score: 64, min: 10.6, max: 10.7 },
		{ score: 62, min: 10.8, max: 10.9 },
		{ score: 60, min: 10.0, max: 11.1 },
		{ score: 50, min: 11.2, max: 11.3 },
		{ score: 40, min: 11.4, max: 11.5 },
		{ score: 30, min: 11.6, max: 11.7 },
		{ score: 20, min: 11.8, max: 11.9 },
		{ score: 10, min: 12.0, max: 12.1 }
	],
	sitAndReach: [
...
const girlScoreStandards = {
	...
	fiftyMeter: [
		...
		{ score: 95, min: 8.8, max: 8.8 },
		{ score: 90, min: 8.9, max: 8.9 },
		{ score: 85, min: 9.0, max: 9.2 },
		{ score: 80, min: 9.3, max: 9.5 },
		{ score: 78, min: 9.6, max: 9.7 },
		{ score: 76, min: 9.8, max: 9.9 },
		{ score: 74, min: 10.0, max: 10.1 },
		{ score: 72, min: 10.2, max: 10.3 },
		{ score: 70, min: 10.4, max: 10.5 },
		{ score: 68, min: 10.6, max: 10.7 },
		{ score: 66, min: 10.8, max: 10.9 },
		{ score: 64, min: 11.0, max: 11.1 },
		{ score: 62, min: 11.2, max: 11.3 },
		{ score: 60, min: 11.4, max: 11.5 },
		{ score: 50, min: 11.6, max: 11.7 },
		{ score: 40, min: 11.8, max: 11.9 },
		{ score: 30, min: 12.0, max: 12.1 },
		{ score: 20, min: 12.2, max: 12.3 },
		{ score: 10, min: 12.4, max: 12.5 }
	],
	sitAndReach: [
...
export function calculateBMIScore(height, weight, isBoy) {
	...
	for (let standard of scoreStandards) {
		if ((standard.min === undefined || bmi >= standard.min) && (standard.max === undefined || bmi <= standard.max)) {
...
export function calculateLungCapacityScore(lungCapacity, isBoy) {
	const standards = isBoy ? boyScoreStandards.lungCapacity : girlScoreStandards.lungCapacity
...
export function calculateSitUpsScore(count, isBoy) {
	const standards = isBoy ? boyScoreStandards.sitUps : girlScoreStandards.sitUps
...
export function calculateEightTimesFiftyMeterScore(time, isBoy) {
	const standards = isBoy ? boyScoreStandards.eightTimesFiftyMeter : girlScoreStandards.eightTimesFiftyMeter
	for (const standard of standards) {
		if ((standard.min === undefined || time >= standard.min) && (standard.max === undefined || time <= standard.max)) {
			return standard.score
		}
	}
	return 0
...
export function calculateFiftyMeterScore(time, isBoy) {
	const standards = isBoy ? boyScoreStandards.fiftyMeter : girlScoreStandards.fiftyMeter
	for (const standard of standards) {
		if ((standard.min === undefined || time >= standard.min) && (standard.max === undefined || time <= standard.max)) {
			return standard.score
		}
...
export function calculateSitAndReachScore(count, isBoy) {
	const standards = isBoy ? boyScoreStandards.sitAndReach : girlScoreStandards.sitAndReach
	for (const standard of standards) {
		if (
			(standard.min === undefined || count >= standard.min) &&
			(standard.max === undefined || count <= standard.max)
...
export function calculateJumpRopeScore(count, isBoy) {
	const standards = isBoy ? boyScoreStandards.jumpRope : girlScoreStandards.jumpRope
	for (const standard of standards) {
		if (
			(standard.min === undefined || count >= standard.min) &&
			(standard.max === undefined || count <= standard.max)
