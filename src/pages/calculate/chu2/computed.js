const boyScoreStandards = {
  lungCapacity: [
    ...
    { score: 10, max: 1559, min: 0 },
  ],
  fiftyMeter: [
    { score: 100, max: 7.5, min: 0 },
    { score: 95, min: 7.6, max: 7.6 },
    { score: 90, min: 7.7, max: 7.7 },
    { score: 85, min: 7.8, max: 7.8 },
    { score: 80, min: 7.9, max: 7.9 },
    { score: 78, min: 8.1, max: 8.1 },
    { score: 76, min: 8.3, max: 8.3 },
    { score: 74, min: 8.5, max: 8.5 },
    { score: 72, min: 8.7, max: 8.7 },
    { score: 70, min: 8.9, max: 8.9 },
    { score: 68, min: 9.1, max: 9.1 },
    { score: 66, min: 9.3, max: 9.3 },
    { score: 64, min: 9.5, max: 9.5 },
    { score: 62, min: 9.7, max: 9.7 },
    { score: 60, min: 9.9, max: 9.9 },
    { score: 50, min: 10.1, max: 10.1 },
    { score: 40, min: 10.3, max: 10.3 },
    { score: 30, min: 10.5, max: 10.5 },
    { score: 20, min: 10.7, max: 10.7 },
...
const girlScoreStandards = {
  ...
  fiftyMeter: [
    { score: 100, min: 0, max: 8.0 },
    { score: 95, min: 8.1, max: 8.1 },
    { score: 90, min: 8.2, max: 8.2 },
    { score: 85, min: 8.5, max: 8.5 },
    { score: 80, min: 8.8, max: 8.8 },
    { score: 78, min: 9.0, max: 9.0 },
    { score: 76, min: 9.2, max: 9.2 },
    { score: 74, min: 9.4, max: 9.4 },
    { score: 72, min: 9.6, max: 9.6 },
    { score: 70, min: 9.8, max: 9.8 },
    { score: 68, min: 10.0, max: 10.0 },
    { score: 66, min: 10.2, max: 10.2 },
    { score: 64, min: 10.4, max: 10.4 },
    { score: 62, min: 10.6, max: 10.6 },
    { score: 60, min: 10.8, max: 10.8 },
    { score: 50, min: 11.0, max: 11.0 },
    { score: 40, min: 11.2, max: 11.2 },
    { score: 30, min: 11.4, max: 11.4 },
    { score: 20, min: 11.6, max: 11.6 },
    { score: 10, min: 11.8, max: Infinity },
  ],
  eightHundredMeter: [
